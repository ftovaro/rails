...
the {Active Model}[link:../activemodel/README_rdoc.html] module.
...
are bundled together in {Action Pack}[link:../actionpack/README_rdoc.html].
...
or to generate the body of an email. In \Rails, View generation is handled by {Action View}[link:../actionview/README_rdoc.html].

== Frameworks and libraries

{Active Record}[link:../activerecord/README_rdoc.html], {Active Model}[link:../activemodel/README_rdoc.html],
{Action Pack}[link:../actionpack/README_rdoc.html], and {Action View}[link:../actionview/README_rdoc.html] can each be used independently outside \Rails.
In addition to that, \Rails also comes with {Action Mailer}[link:../actionmailer/README_rdoc.html], a library
to generate and send emails; {Active Job}[link:../activejob/README_md.html], a
framework for declaring jobs and making them run on a variety of queueing
backends; {Action Cable}[link:../actioncable/README_md.html], a framework to
integrate WebSockets with a \Rails application; {Active Storage}[link:../activestorage/README_md.html],
a library to attach cloud and local files to \Rails applications;
and {Active Support}[link:../activesupport/README_rdoc.html], a collection
